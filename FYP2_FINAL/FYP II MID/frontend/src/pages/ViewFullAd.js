      ...
      <div className="content-div">
        ...
        <div className="Features-div">
          ...
          <div className="mainrating-div">
            ...
            <>
              ...
              <ul className="list-group">
                {reviews && reviews.length !== 0
                  ? reviews.map((rev) => {
                      return (
                        <li className="list-group-item b-d">
                          <h6 className="rev-username">{rev.username}</h6>
                          <div className="individual-rating">
                            <h3 className="indi-rating">Ratings:</h3>
                            <Rate
                          ...
                          <p className="review-para">{rev.review}</p>
                          {rev.userId.toString() === userid ? (
                            <button
                              className="red-btn"
                              onClick={() => {
                                delfunc(rev._id);
            ...
            {userId !== userid ? (
              <>
                <h2 className="add-review-tag">Add Review</h2>
                <label className="l1">Review</label>
                <input
                  type="text"
                  class="review-field"
                ...
                />
                <br></br>
                <label className="l2">Rate user</label>
                <input
                  type="Number"
                  class="rating-field"
                  placeholder=" Rate User out of 5"
                  value={rating}
                  onChange={(e) => {
