...
export default function SignUp() {
  ...
  const [valmsg3, setvalmsg3] = useState(null);
  const [valmsg4, setvalmsg4] = useState(null);
        ...
        <div className="row shadow  ">
          ...
          <div className="col-md-9 register-right">
            <div className="tab-control" id="myTabContent">
              ...
              >
                <h3 className="hhh">Get yourself registered</h3>
                <form className="form-signup" onSubmit={onSubmit}>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (!/\d/.test(input)) {
                              ...
                              setvalmsg3("Input a valid value");
                            }
                          }}
                          required
                        />
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (!/\d/.test(input)) {
                              ...
                              setvalmsg4("Input a valid value");
                            }
                          }}
                          required
                        />
                  ...
                  <input
                    type="submit"
                    className="btn btn-warning py-1 w-25 button-size"
                    value="Register"
